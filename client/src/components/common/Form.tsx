    ...
    return (
        <Box>
            ...
            <Box mt={2.5} borderRadius="15px" padding="20px" bgcolor="#fcfcfc">
                <form style={{ marginTop: '20px', width: '100%', display: 'flex', gap: '20px', flexDirection: "column" }}
                ...
                >
                    ...
                    <FormControl>
                        <FormHelperText sx={{ fontWeight: 500, margin: '10px 0', fontSize: 16, color: '#11142d' }}> Enter Property Discription</FormHelperText>
                        <TextareaAutosize
                            minRows={5}
                            required
                    ...
                    <FormControl>
                        ...
                        <Stack direction="column" gap={1}
                            ...
                            <Stack direction="row" gap={2}>
                                ...
                                <Button component="label" sx={{ weidth: 'fit-content', color: '#2ed480', textTransform: 'capitalize', fontSize: 16 }}>
                                    Upload *
                                    <input
                                        hidden
                                        accept="image/*"
